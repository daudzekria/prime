	...
	<div class="container">
		<div class="row row-spacing-lg">
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				<p class="">Executing below the line so that we maximise share of voice. Targeting agile and possibly think outside the box. Synchronise big data so that as an end result, we make the logo bigger.</p>
				<p class="">Targeting a holistic approach yet make users into advocates. Taking user stories to, consequently, target the low hanging fruit.</p>
				<div class="row ">
					<div class="col-md-12 col-xs-12 col-sm-12">
						<div class="bg-img bg-img-3 bg-box bg-box-square bg-box-cover color-4-text-contrast color4-background-color" style="margin-top: 2.2em; padding: 2em 3em;">
							<p style="font-weight: 400; margin-bottom: .3em;" data-font-weight="400">Address:</p>
							<p style="margin-bottom: .3em;">1234 Franconia Way</p>
							<p class="">New York City, New York 65432</p>
							<p style="font-weight: 400; margin-bottom: .3em;" data-font-weight="400">Email:</p>
							<p class=""><a href="#">support@example.com</a></p>
							<p style="font-weight: 400; margin-bottom: .3em;" data-font-weight="400">Phone:</p>
